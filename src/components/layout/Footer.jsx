...
const Footer = () => {
    ...
    return (
        <StledFooter>
            <Nav>
                <Navitem>
                    <h3 onClick={() => {handleClike(1)}}>comppany</h3>
                    <StyledListHr />
                    <StyledCompanyDes $show={showCompanyDes}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis provident amet ex esse odio. Aliquid blanditiis ex ea, voluptatem vero sunt soluta. Ea doloribus sint qui iste similique, tenetur ipsum sequi, temporibus porro doloremque dolore accusamus? Eum, sequi. Doloribus provident ex quia quaerat doloremque ea ab sed. Cumque dolor modi, incidunt nulla magni quae culpa, autem laudantium fugiat nam voluptatibus iusto neque perspiciatis vel eius quos officia soluta commodi asperiores omnis! Perspiciatis, distinctio repellat culpa iste, eveniet beatae eaque eligendi odio amet est facilis aut facere autem labore voluptatum repudiandae id rem praesentium provident cum accusamus corrupti? Quasi, maiores exercitationem.</StyledCompanyDes>
                </Navitem>
                <Navitem>
                    <h3 onClick={() => {handleClike(2)}}>help</h3>
                    <StyledListHr />
                ...
                <Navitem>
                    <h3 onClick={() => {handleClike(3)}}>follow us</h3>
                    <StyledListHr />
