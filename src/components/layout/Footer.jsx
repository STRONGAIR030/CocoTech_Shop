...
const Footer = () => {
    ...
    const handleClike = (id) => {
        const handlers = {
            1: () => {
                setCompanyDes((prevShow) => !prevShow);
            },
            2: () => {
                setHelp((prevShow) => !prevShow);
            },
            3: () => {
                setFollowUs((prevShow) => !prevShow);
            },
        };
            ...
            <Nav>
                <Navitem>
                    ...
                    <StyledCompanyDes $show={showCompanyDes}>
                        About Us: ChocoTech combines the sweetness of indulgence
                        with cutting-edge technology. Established with a vision
                        to bring innovative chocolate creations to life, we
                        specialize in crafting everyday items entirely from
                        high-quality, edible chocolate. From tech gadgets to
                        household tools, ChocoTech transforms the ordinary into
                        extraordinary, blending functionality with a touch of
                        decadence.
                        <br />
                        <br />
                        Mission: To revolutionize the way people experience
                        chocolate by fusing it with modern technology and
                        innovative design.
                        <br />
                        <br />
                        Vision: To become the leading brand in chocolate
                        craftsmanship, known for creating products that are as
                        delightful to use as they are to taste.
                    </StyledCompanyDes>
                </Navitem>
                <Navitem>
                    <h3
                ...
                <Navitem>
                    ...
                    <StyledFollowUsList $show={showFollowUs}>
                        <FollowUsitem iconUrl={"/img/apartment.svg"}>
                            (05) 1234567
                        </FollowUsitem>
                        <FollowUsitem iconUrl={"/img/call.svg"}>
                            (09) 1234567
                        </FollowUsitem>
                        <FollowUsitem iconUrl={"/img/mail.svg"}>
                            user1234@mail.com
                        </FollowUsitem>
                        <SocialMediaList />
                    </StyledFollowUsList>
